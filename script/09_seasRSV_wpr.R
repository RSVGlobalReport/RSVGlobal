...
#====================================================================
#YEAR ON YEAR RSV DYNAMICS IN WESTERN PACIFIC
#====================================================================
...
plot19 = plotly::ggplotly(
  rsv_wpr %>%
    ...
    labs(title = "14-days Rolling Average RSV cases in Western Pacific, from 2017+ years", x = "Date", y = "RSV cases"))

htmlwidgets::saveWidget(as_widget(plot19), here("output", "yearOnyear_all_western_pacific", file = "all_western_pacific_yearOnyear.html"))
...
for (i in c("Australia", "Japan", "Mongolia", "Malaysia")) {
  ...
  htmlwidgets::saveWidget(as_widget(plot20), here("output", "weekly_each_country", file = paste0("CountryWeekly_", i,".html")))
...
for (i in c("Australia", "Japan", "Mongolia", "Malaysia")) {
  ...
  htmlwidgets::saveWidget(as_widget(plot21), here("output", "covid_each_country", file = paste0("CountryCovid_", i,".html")))
