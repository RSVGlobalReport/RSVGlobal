...
for (i in c("Africa", "North Americas", "South Americas", "Eastern Mediterranean", "Europe", "South East Asia", "Western Pacific")) {
  ...
  htmlwidgets::saveWidget(as_widget(plot1), here("output", "timeseries_each_region", file = paste0("timeseries_", i,".html")))
...
region_wk <-
  ...
  mutate(seas = case_when((region == "Europe" | region == "Eastern Mediterranean" | region == "North Americas") & wk %in% wkno2 & yr == 2017 ~ "2017/18",
                          ...
                          (region == "Europe" | region == "Eastern Mediterranean" | region == "North Americas") & wk %in% wkno2 & yr == 2019 ~ "2019/20",
                          (region == "Europe" | region == "Eastern Mediterranean" | region == "North Americas") & wk %in% wkno1 & yr == 2020 ~ "2019/20",
                          (region == "Europe" | region == "Eastern Mediterranean" | region == "North Americas") & wk %in% wkno2 & yr == 2020 ~ "2020/21",
                          (region == "Europe" | region == "Eastern Mediterranean" | region == "North Americas") & wk %in% wkno1 & yr == 2021 ~ "2020/21",
                          (region == "Europe" | region == "Eastern Mediterranean" | region == "North Americas") & wk %in% wkno2 & yr == 2021 ~ "2021/22",
                          (region == "Europe" | region == "Eastern Mediterranean" | region == "North Americas") & wk %in% wkno1 & yr == 2022 ~ "2021/22",
                          (region == "Europe" | region == "Eastern Mediterranean" | region == "North Americas") & wk %in% wkno2 & yr == 2022 ~ "2022/23",
                          (region == "Europe" | region == "Eastern Mediterranean" | region == "North Americas") & wk %in% wkno1 & yr == 2023 ~ "2022/23",
                          (region == "Europe" | region == "Eastern Mediterranean" | region == "North Americas") & wk %in% wkno2 & yr == 2023 ~ "2023/24",
                          (region == "Europe" | region == "Eastern Mediterranean" | region == "North Americas") & wk %in% wkno1 & yr == 2024 ~ "2023/24",
                          (region == "Europe" | region == "Eastern Mediterranean" | region == "North Americas") & wk %in% wkno2 & yr == 2024 ~ "2024/25",
                          (region == "Europe" | region == "Eastern Mediterranean" | region == "North Americas") & wk %in% wkno1 & yr == 2025 ~ "2024/25",
                          TRUE ~ NA_character_))

for (i in c("Africa", "South Americas", "South East Asia", "Western Pacific")) {
...
htmlwidgets::saveWidget(as_widget(plot2), here("output", "weekly_each_region", file = paste0("weekly_", i,".html")))
unlink(paste0(here("output", "weekly_each_region", paste0("weekly_",i,"_files"))), recursive = TRUE) #delete metadata
}

for (i in c("North Americas", "Europe", "Eastern Mediterranean")) {
...
for (i in c("Africa", "South Americas", "South East Asia", "Western Pacific")) {
  ...
  htmlwidgets::saveWidget(as_widget(plot4), here("output", "covidimpact_each_region", file = paste0("covidimpact_", i,".html")))
