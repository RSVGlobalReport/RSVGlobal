...
#====================================================================
#TIME SERIES OF RSV DYNAMICS BY EACH COUNTRY IN AFRICA
#====================================================================
...
htmlwidgets::saveWidget(as_widget(plot13), here("output", "timeseries_each_country", file = paste0("timeseries_", i,".html")))
unlink(paste0(here("output", "timeseries_each_country", paste0("timeseries_",i,"_files"))), recursive = TRUE) #delete metadata
}

#====================================================================
#WEEKLY RSV DYNAMICS BY EACH COUNTRY IN AFRICA
#====================================================================
...
for (i in c("Central African Republic", "Ivory Coast", "Madagascar", "South Africa")) {
  ...
  htmlwidgets::saveWidget(as_widget(plot14), here("output", "weekly_each_country", file = paste0("weekly_", i,".html")))
...
for (i in c("Central African Republic", "Ivory Coast", "Madagascar", "South Africa")) {
  ...
  htmlwidgets::saveWidget(as_widget(plot15), here("output", "covidimpact_each_country", file = paste0("covidimpact_", i,".html")))
