...
### Dynamics of RSV by WHO region

```{r PlotRSV1, message = FALSE, warning = FALSE, fig.width = 15, fig.height = 6, fig.align = 'center'}
...
### Dynamics of RSV by Hemisphere

```{r PlotRSV2, message = FALSE, warning = FALSE, fig.width = 11, fig.height = 5, fig.align = 'center'}
...
```{r PlotRSV3, message = FALSE, warning = FALSE, fig.width = 15, fig.height = 13, fig.align = 'center'}
...
```{r PlotRSV4, message = FALSE, warning = FALSE, fig.width = 15, fig.height = 13, fig.align = 'center'}
...
```{r PlotRSV5, message = FALSE, warning = FALSE, fig.width = 15, fig.height = 13, fig.align = 'center'}
...
```{r PlotRSV6, message = FALSE, warning = FALSE, fig.width = 12, fig.height = 18, fig.align = 'center'}
