...
#====================================================================
#TIME SERIES OF RSV DYNAMICS BY EACH COUNTRY IN AMERICAS
#====================================================================
...
for (i in c("Argentina", "Belize", "Bolivia", "Brazil", "Canada", "Colombia", "Costa Rica", "Nicaragua", "Panama",
  ...
  htmlwidgets::saveWidget(as_widget(plot22), here("output", "timeseries_each_country", file = paste0("timeseries_", i,".html")))
  unlink(paste0(here("output", "timeseries_each_country", paste0("timeseries_",i,"_files"))), recursive = TRUE) #delete metadata
}


#====================================================================
#WEEKLY RSV DYNAMICS BY EACH COUNTRY IN AMERICAS
#====================================================================
...
for (i in c("Argentina", "Belize", "Bolivia", "Brazil", "Canada", "Colombia", "Costa Rica", "Nicaragua", "Panama",
  ...
  htmlwidgets::saveWidget(as_widget(plot23), here("output", "weekly_each_country", file = paste0("weekly_", i,".html")))
  unlink(paste0(here("output", "weekly_each_country", paste0("weekly_",i,"_files"))), recursive = TRUE) #delete metadata
}


#====================================================================
#COVID-19 IMPACT ON RSV DYNAMICS BY EACH COUNTRY IN AMERICAS
#====================================================================
...
for (i in c("Argentina", "Belize", "Bolivia", "Brazil", "Canada", "Colombia", "Costa Rica", "Nicaragua", "Panama",
  ...
  htmlwidgets::saveWidget(as_widget(plot24), here("output", "covidimpact_each_country", file = paste0("covidimpact_", i,".html")))
